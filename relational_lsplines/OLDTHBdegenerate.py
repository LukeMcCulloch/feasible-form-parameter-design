...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr 20 01:31:23 2018
...
This one splits the fwd tcurve around the aft of the bulb
"""
#
import numpy as np
import copy
...
class Bulb(object):
    ...
    def return_outline_vertices(self,num2use=3):
        """Returns the outline of the bulb
        in the form we'd like.
        -in this file, it is the aft outline.
...
class ComplexHull(object):
    def __init__(self):
        ...
        #**********************************************************************
        # 
        self.num2use    = 2 #number of  transverse bulb curves 
                            #to use for the bulb
