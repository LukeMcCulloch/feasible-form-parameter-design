...
#        p1,p2=self.intersect_cp_segments(i=4,j=1)
        ...
        L0.curve.plotCurvature_nospines()
        box1.plot()
        #"""
        curve = Lspline.curve
        #"""
        ...
        L1.curve.plotCurvature_nospines()
        box1.plot()
        #"""
        curve = Lspline.curve
        ...
        #alphae = 45.
        ##
        ## could put an "or" condition on these point constraints
        ##
        ...
        L2.curve.plotCurvature_spines(scale=.85)
